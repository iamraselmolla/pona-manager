...
export const authAPI = {
  ...
  updateProfile: (data: Partial<User>) => apiClient.put<ApiResponse<User>>('/auth/profile', data),
};
...
export const customerAPI = {
  ...
  create: (data: Partial<Customer>) => apiClient.post<ApiResponse<Customer>>('/customers', data),

  update: (id: string, data: Partial<Customer>) =>
    apiClient.put<ApiResponse<Customer>>(`/customers/${id}`, data),

  delete: (id: string) => apiClient.delete<ApiResponse<null>>(`/customers/${id}`),

  getOrders: (id: string) => apiClient.get<ApiResponse<Order[]>>(`/customers/${id}/orders`),

  getPayments: (id: string) => apiClient.get<ApiResponse<Payment[]>>(`/customers/${id}/payments`),
};
...
export const orderAPI = {
  ...
  delete: (id: string) => apiClient.delete<ApiResponse<Order>>(`/orders/${id}`),
  ...
  create: (data: Partial<Order>) => apiClient.post<ApiResponse<Order>>('/orders', data),
...
export const deliveryAPI = {
  ...
  getById: (id: string) => apiClient.get<ApiResponse<Delivery>>(`/deliveries/${id}`),

  create: (data: Partial<Delivery>) => apiClient.post<ApiResponse<Delivery>>('/deliveries', data),
...
export const expenseAPI = {
  ...
  delete: (id: string) => apiClient.delete<ApiResponse<null>>(`/expenses/${id}`),
};
...
export const dailyClosingAPI = {
  ...
  getByDate: (date: string) => apiClient.get<ApiResponse<DailyClosing>>(`/daily-closing/${date}`),

  getTodaySummary: () => apiClient.get<ApiResponse<DailyClosing>>('/daily-closing/today/summary'),
...
export const reportAPI = {
  ...
  getCustomerDue: () => apiClient.get<ApiResponse<any>>('/reports/customer-due'),
