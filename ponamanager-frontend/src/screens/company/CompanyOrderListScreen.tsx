  ...
  return (
    <Animated.View style={{ opacity: fade, transform: [{ translateY: slide }] }}>
      <TouchableOpacity
        style={[
          styles.card,
          { backgroundColor: T.surface, borderColor: T.border, borderLeftColor: ponaColor },
        ]}
        onPress={onPress}
        activeOpacity={0.82}
      >
        ...
        <View style={styles.cardTop}>
          <View style={styles.cardTopLeft}>
            ...
            <View
              style={[
                styles.ponaBadge,
                { backgroundColor: ponaColor + '18', borderColor: ponaColor + '44' },
              ]}
            >
        ...
        <View style={styles.cardMid}>
          ...
          <View style={styles.statBox}>
            ...
            <Text style={[styles.statValue, { color: T.accent }]}>
              {(item.expectedPL ?? 0).toLocaleString()}
            </Text>
          </View>
        </View>
          ...
          <>
            ...
            <View style={styles.deliveredRow}>
              <View style={styles.deliveredStat}>
                ...
                <Text style={[styles.deliveredValue, { color: T.textPrimary }]}>
                  {item.mirValue ?? '—'}
                </Text>
              </View>
              <View style={styles.deliveredStat}>
              ...
              <View style={styles.deliveredStat}>
                ...
                <Text style={[styles.deliveredValue, { color: ponaColor }]}>
                  {(item.totalPL ?? 0).toLocaleString()}
                </Text>
              </View>
              {(item.netDue ?? 0) > 0 && (
                <View style={[styles.dueChip, { backgroundColor: T.dangerSoft }]}>
                  <Text style={[styles.dueChipText, { color: T.danger }]}>
              ...
              {(item.netAdvance ?? 0) > 0 && (
                <View style={[styles.advChip, { backgroundColor: T.successSoft }]}>
                  <Text style={[styles.advChipText, { color: T.success }]}>
        ...
        <View style={styles.summaryRow}>
          ...
          {totalDue > 0 && (
            <View style={[styles.summaryChip, { backgroundColor: T.dangerSoft }]}>
              ...
              <Text style={[styles.summaryChipText, { color: T.danger }]}>
                বাকি {formatCurrency(totalDue)}
              </Text>
            </View>
          )}
          {totalAdvance > 0 && (
            <View style={[styles.summaryChip, { backgroundColor: T.successSoft }]}>
              ...
              <Text style={[styles.summaryChipText, { color: T.success }]}>
                অগ্রীম {formatCurrency(totalAdvance)}
              </Text>
            </View>
          )}
        </View>
      ...
      <View style={[styles.filterRow, { marginTop: -6 }]}>
        {PONA_FILTERS.map((f) => {
          ...
          return (
            ...
            >
              <Text
                style={[styles.filterChipText, { color: T.textSecondary }, active && { color }]}
              >
                {f.label}
              </Text>
            </TouchableOpacity>
