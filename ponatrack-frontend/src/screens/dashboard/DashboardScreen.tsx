    ...
    >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.quickActions}>
          {[
            ...
            >
              <View
                style={[styles.quickIcon, { backgroundColor: a.color + "20" }]}
              >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statsGrid}>
          ...
          <StatCard
            title="PL Delivered"
            value={formatNumber(stats?.totalPLDelivered || 0)}
            icon="fish-outline"
            color={COLORS.info}
            bg={COLORS.infoLight}
          />
          ...
          <StatCard
            title="Company Mir"
            value={formatNumber(stats?.totalCompanyMir || 0)}
            icon="cube-outline"
          ...
          <View style={styles.chartCard}>
            <LineChart
              data={{
                ...
                datasets: [
                  { data: stats.dailySales.map((d: any) => d.amount) },
                ],
              }}
              width={width - 48}
              height={180}
          ...
          <View style={styles.chartCard}>
            <BarChart
              data={{
                ...
                datasets: [
                  { data: stats.monthlySales.map((m: any) => m.amount) },
                ],
              }}
              width={width - 48}
              height={200}
